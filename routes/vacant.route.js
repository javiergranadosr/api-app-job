...
const { create } = require("../controllers/index.controller");
const { validateJwt } = require("../middlewares/validate.jwt");
const { hasRole } = require("../middlewares/validate.role");
const validate = require("../middlewares/validate");
const { existUserById,  existCategoryById } = require("../helpers/custom.validations");
...
router.post(
  ...
  [
    validateJwt,
    hasRole("RECRUITER"),
    check("author", "El identificador de usuario es requerido.").not().isEmpty(),
    ...
    check("category", "La categoría de la vacante es requerida.").not().isEmpty(),
    check("category", "El identificador de la categoría es invalido.").isMongoId(),
    ...
    check("description", "La descripción de la vacante es requerida.").not().isEmpty(),
